...
ПРАВИЛА:
1. Если в вопросе есть любая арифметика (разность, отношение, произведение,
   накопление, «во сколько раз», «реальная ставка» и т.п.) — ОБЯЗАТЕЛЬНО
   добавь отдельный подвопрос с expected_tools=["calculate"].
